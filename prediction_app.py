...
path='/Users/bhanuprakash/NewProject/get-started-python/'
...
def get_model():
    global model
    model = tf.keras.models.load_model(path+'Model_directoutput.h5')
    # model.load_weigths('/Users/bhanuprakash/Downloads/Model_directweigths.h5')
    print(' * Model loaded!')


def data_gathering(latitude, longitude):
    nc = xr.open_dataset(path+'download.nc')
